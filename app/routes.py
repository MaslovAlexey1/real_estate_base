...
def real_estate_base():
	...
	if object_type == 1:
		...
		object_type = 'Апартамент'
	elif object_type == 3:
		object_type = 'Машино-место'
	elif object_type == 4:
		object_type = 'Кладовка'
	elif object_type == 5:
		object_type = 'Нежилое'
	elif object_type == 6:
		object_type = 'Кв/ап'
	...
	if zone == 1:
		...
		zone = '3) от ~ТТК до МКАД'
	elif zone == 4:
		zone = '4) Москва за МКАД'
	elif zone == 5:
		zone = '5) Н. Москва ближ.'
	elif zone == 6:
		zone = '6) Н. Москва дальн.'
	elif zone == 7:
		zone = '7) МО ближ.'
	elif zone == 8:
		zone = '8) МО ср.'
	...
	o.type_studio, o.type, o.decoration, o.price_discont, h.name house_name, \
	...
	# object = Object.query.from_statement(stmt)
